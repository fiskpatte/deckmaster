import { DeckMapElement } from "../types/deckMap";
...
export const getDeckMapElementEdges = (elem: DeckMapElement) => {
...
export const isAdjacent = (
  ...
  const elemEndpoints = getDeckMapElementEdges(elem);
  const newElemEndpoints = getDeckMapElementEdges(newElem);
